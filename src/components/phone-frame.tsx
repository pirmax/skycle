...
type PlaceholderFrameProps = React.SVGProps<SVGSVGElement>;

function PlaceholderFrame({ ...props }: PlaceholderFrameProps) {
  return (
...
export function PhoneFrame({
  ...
  return (
    <div className={clsx("relative aspect-[366/729]", className)} {...props}>
      ...
      <div className="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-yellow-500 pt-[calc(23/318*100%)]">
        {children}
      </div>
