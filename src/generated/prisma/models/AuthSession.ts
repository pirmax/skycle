...
export type AuthSessionWhereInput = {
  ...
  key?: Prisma.StringFilter<"AuthSession"> | string
  session?: Prisma.StringFilter<"AuthSession"> | string
}
...
export type AuthSessionScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"AuthSession"> | string
  session?: Prisma.StringWithAggregatesFilter<"AuthSession"> | string
}
...
export type AuthSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "session", ExtArgs["result"]["authSession"]>
...
export interface AuthSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const authSessionWithKeyOnly = await prisma.authSession.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthSessions and only return the `key`
   * const authSessionWithKeyOnly = await prisma.authSession.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AuthSessions and only return the `key`
   * const authSessionWithKeyOnly = await prisma.authSession.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuthSessionFieldRefs {
  readonly key: Prisma.FieldRef<"AuthSession", 'String'>
  readonly session: Prisma.FieldRef<"AuthSession", 'String'>
}
